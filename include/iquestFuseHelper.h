 ...
 * iquestFuseHelper.h
 * 
 * Declarations of helper functions for iquestFuse.
 *****************************************************************************/
...
int
iquestFuseConnInuse (iquest_fuse_irods_conn_t *iquestFuseConn);
int
...
int
fillIFuseDesc (int descInx, iquest_fuse_irods_conn_t *iquestFuseConn, int iFd, char *objPath,
char *localPath);
int
...
int
useIFuseConn (iquest_fuse_irods_conn_t *iquestFuseConn);
int
useFreeIFuseConn (iquest_fuse_irods_conn_t *iquestFuseConn);
int
_useIFuseConn (iquest_fuse_irods_conn_t *iquestFuseConn);
int
unuseIFuseConn (iquest_fuse_irods_conn_t *iquestFuseConn);
int
relIFuseConn (iquest_fuse_irods_conn_t *iquestFuseConn);
int
_relIFuseConn (iquest_fuse_irods_conn_t *iquestFuseConn);
...
int
closeIrodsFd (iquest_fuse_irods_conn_t *iquestFuseConn, int fd);
int
...
int
irodsOpenWithReadCache (iquest_fuse_irods_conn_t *iquestFuseConn, char *path, int flags);
int
...
int dataObjCreateByFusePath (iquest_fuse_irods_conn_t *iquestFuseConn, char *path, int mode, char *outIrodsPath);
int
ifusePut (iquest_fuse_irods_conn_t *iquestFuseConn, char *path, char *locCachePath, int mode,
rodsLong_t srcSize);
int
freeFileCache (pathCache_t *tmpPathCache);
int ifuseReconnect (iquest_fuse_irods_conn_t *iquestFuseConn);
int ifuseConnect (iquest_fuse_irods_conn_t *iquestFuseConn);
int
getNewlyCreatedDescByPath (char *path);
int renmeOpenedIFuseDesc(iquest_fuse_t *iqf, pathCache_t *fromPathCache, char *to);
int map_irods_fuse_errors(int irods_err, int fuse_err);
